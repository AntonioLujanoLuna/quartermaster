...
if (Test-Path -LiteralPath $PidPath) {
    ...
    if ($existing -and $existing.CommandLine -match 'quartermaster.*\brun\b') {
...
$process = Start-Process -FilePath 'uv' -ArgumentList $arguments -WorkingDirectory $repo -RedirectStandardOutput $stdout -RedirectStandardError $stderr -PassThru
